      ...
      <div className="navbar grid bg-blue-500 p-2 shadow-md grid-cols-3 items-center justify-between">
        <div className="left-section">
          <div className="logo-search-wrapper flex items-center gap-3">
            <Link to="/">
              <img
                src="https://upload.wikimedia.org/wikipedia/en/b/b6/Graphic_Era_Hill_University_Logo.png"
                alt="Logo"
                className="logo h-7 rounded-full cursor-pointer"
              />
            </Link>
            <SearchBar />
          </div>
        ...
        <div className="right-section  flex flex-wrap items-center justify-end gap-3 md:mr-4">
          ...
          <div className="logout" onClick={handleLogout}>
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="w-7 h-7 fill-gray-300 active:fill-gray-200 cursor-pointer"
            >
              <path
                fillRule="evenodd"
